...
public class IfElseeifStatementsQuestion_3 {
    public static void main(String[] args) {

        // İstifadəçidən alınan məhsulların sayını və siyahı qiymətini
        // alın və istifadəçidən müştəri kartı olub-olmadığını soruşun.
        // Müştəri kartı varsa 10-dan çox məhsul alana 20%,
        // yoxsa 15%, müştəri kartı yoxdursa, 10-dan çox məhsul alana 15%
        // endirim edin. yoxsa, 10% endirim edin
        ...
        if (kart.equalsIgnoreCase("beli") && mesulSayi >= 10){
            endirim = mesulSayi * mesulQiymeti * (0.8);
            System.out.println("Size 20% endirim olundu! " + endirim);
        } else if (kart.equalsIgnoreCase("beli") && mesulSayi > 0 && mesulSayi < 10) {
            endirim = mesulSayi * mesulQiymeti * (0.85);
            System.out.println("Size 15% endirim olundu! " + endirim);
        } else if (kart.equalsIgnoreCase("xeyir") && mesulSayi >= 10) {
            endirim = mesulSayi * mesulQiymeti * (0.85);
            System.out.println("Size 20% endirim olundu! " + endirim);
        } else if (kart.equalsIgnoreCase("xeyir") && mesulSayi > 0 && mesulSayi < 10) {
            endirim = mesulSayi * mesulQiymeti * (0.85);
