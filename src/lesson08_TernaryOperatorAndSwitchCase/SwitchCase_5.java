...
public class SwitchCase_5 {
    public static void main(String[] args) {
        ...
        // istifadeciden 2 basamaqli bir reqem alib, daxil olunan sayiyi yazi ile yazdirin.

        Scanner scanner = new Scanner(System.in);
        System.out.print("zehmet olmasa yaziyla gorunmesini  istediuiniz tam sayiyi daxil edin: ");
